    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto">
      ...
      <div className="space-y-8 pb-20">
        {sections.map((section, idx) => (
          <div key={section.title} className="bg-white dark:bg-neutral-900 rounded-[2.5rem] border border-neutral-200 dark:border-neutral-800 overflow-hidden shadow-sm">
        ...
        <div className="p-10 rounded-[2.5rem] bg-status-error/5 dark:bg-status-error/10 border border-status-error/20 dark:border-status-error/30">
...
const ChevronDown = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinelinejoin="round" className={className} {...props}><path d="m6 9 6 6 6-6"/></svg>
);
